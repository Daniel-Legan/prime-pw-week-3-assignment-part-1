...
let favoriteFoods = ['pizza', 'ice cream', 'pho', 'bread', 'hot pot'];
...
console.log('Removed the last favorite food', removedFavoriteFoods);
...
console.log('Removed the first favorite food', removedFavoriteFoods);
console.log('The favorite foods are now', favoriteFoods);

// 4.e (STRETCH) TODO: Replace the second food in your array
//      with another one of your favorite foods.
//      Then log the updated array.
favoriteFoods[1] = 'strawberries';
console.log('The favorite foods are now', favoriteFoods);
